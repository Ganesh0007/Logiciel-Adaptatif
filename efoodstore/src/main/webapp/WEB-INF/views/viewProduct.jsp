...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Page Produit !        System.out.println(path);
            </p>
        </div>
        ...
        <div class="container" ng-app = "cartApp">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>
                       <strong>Fournisseur</strong> : ${product.productManufacturer}
                    </p>
                    <p>
                    ...
                    <p ng-controller="cartCtrl">
                        ...
                        <a href="<spring:url value="/customer/cart" />"
                           class="btn btn-default"><span class="glyphicon glyphicon-hand-right"></span>Voir Panier</a>
                    </p>
                </div>
            </div>
        </div>
